...
public class MainActivity extends AppCompatActivity {
    ...
    static final String AUTHORITY = "content://se.iuh.contentprovider.AccountProvider/accounts";
    ...
    public ArrayList<Account> selectAll() {
        ...
        Cursor cur = getContentResolver().query(CONTENT_URI, null, "Select * from accounts", null, null);
